  ...
  return (
    ...
    >
      ...
      <input
        ...
        placeholder="何をしたいですか？ 例: 「うどんを手作りしたい」"
        aria-label="新しいタスクを入力"
        aria-busy={isLoading}
        className="flex-1 bg-transparent border-none outline-none text-foreground placeholder:text-muted-foreground/50 py-3 text-lg"
        disabled={isLoading}
      />
      <div className="pr-2">
        <motion.button
